...
<script type="text/javascript" src="<c:url value="/static/js/jquery-3.2.1.min.js/js/jquery-3.2.1.min.js" />"></script>
<script type="text/javascript" src="<c:url value="/static/js/bootstrap.min.js/js/bootstrap.min.js" />"></script>
<script type="text/javascript" src="<c:url value="/static/js/main.js/js/main.js" />"></script>
</body>
</html>